...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(counts, 
                    values='count', 
                    names='class', 
                    title=f'Proportion of Successful Launches at {entered_site}')
    return fig
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        filtered2_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        fig = px.scatter(filtered2_df, x='Payload Mass (kg)', y='class' ,
                    color='Booster Version Category', 
                    title=f'Success by Payload {entered_site}')
    return fig
